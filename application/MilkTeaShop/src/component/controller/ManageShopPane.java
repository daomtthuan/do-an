...
import component.controller.managepane.ManageTablePane;
...
public class ManageShopPane implements Controller, Initializable {
	...
	private void manageTable() {
		subManageComponent.getChildren().clear();
		subManageComponent.getChildren().add(PrimaryStage.getInstance().loadComponent("/component/view/managepane/ManagePane.fxml", new ManageTablePane()));
	}
